...
DOCKER_CMD="docker run -e LOCAL_USER_ID=`id -u $USER` --rm  -v $PWD:$PWD carinerey/pcoc:v1.1.0.beta"
...
$DOCKER_CMD pcoc_det.py -cpu 2 --no_mixture --V1 -t $tree -aa $ali -o $PWD/output_pcoc_det -m 0/3
...
#$DOCKER_CMD pcoc_det.py --no_mixture --V1 -t $tree -aa $ali -o $PWD/output_pcoc_det -m 0/3 --plot_complete_ali --plot --reorder --gamma -plot_title "Test PCOC"
