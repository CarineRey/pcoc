...
#$DOCKER_CMD  bash -c "pcoc_sim.py -td $TREES_DIR -o $OUTPUT_DIR/test1 -n_sc 1 -nb_sampled_couple 1 -sim_profiles $DATA_DIR/C10_aa_frequencies.csv -est_profiles $DATA_DIR/C10_aa_frequencies.csv -n_sites 10 -c 5 -c_max 7 -cpu 1  $meth $debug --plot_ali -min_dist_CAT 0 --no_clean_seqs"
$DOCKER_CMD  bash -c "pcoc_sim.py -td $TREES_DIR -o $OUTPUT_DIR/test1 -n_sc 1 -nb_sampled_couple 1 -sim_profiles $DATA_DIR/aa_order_checking.csv -est_profiles C10 -n_sites 10 -c 5 -c_max 7 -cpu 1  $meth $debug --plot_ali -min_dist_CAT 0 --no_clean_seqs"
$DOCKER_CMD  bash -c "pcoc_sim.py -td $TREES_DIR -o $OUTPUT_DIR/test1 -n_sc 1 -nb_sampled_couple 1 -sim_profiles $DATA_DIR/aa_per_properties.csv -est_profiles $DATA_DIR/aa_per_properties.csv -n_sites 10 -c 5 -c_max 7 -cpu 1  $meth $debug --plot_ali -min_dist_CAT 0 --no_clean_seqs"
$DOCKER_CMD  bash -c "pcoc_sim.py -td $TREES_DIR -o $OUTPUT_DIR/test1 -n_sc 1 -nb_sampled_couple 1 -sim_profiles $DATA_DIR/aa_per_properties.csv -n_sites 10 -c 5 -c_max 7 -cpu 1  $meth $debug --plot_ali -min_dist_CAT 0 --no_clean_seqs"
